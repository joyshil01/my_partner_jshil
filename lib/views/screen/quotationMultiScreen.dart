...
class QuotationMultiScreen extends StatefulWidget {
  @override
  State<QuotationMultiScreen> createState() => _QuotationMultiScreenState();
}

class _QuotationMultiScreenState extends State<QuotationMultiScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => InkWell(
          onTap: () {
            Navigator.pushNamed(context, RouteNames.quotationmultiform);
          },
          child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  left: 7.0, right: 7.0, top: 2.8, bottom: 2.8),
                              child: Center(
                                child: FittedBox(
                                  fit: BoxFit.contain,
                                  child: Column(
